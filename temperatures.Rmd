...
ggplot() + geom_sf(data = single_sf) + geom_sf(data = stations_sf, aes(label = STATION), shape = 4, color = "darkred", size = 5) 
```

Create grid for krigging. 10km grid is already available so I will first import it:
```{r, echo=FALSE, message=FALSE}
