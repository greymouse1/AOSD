...
In this work, we want to answer the following questions:
  ...
  * By looking at the results of krigging, can we notice any factors which may influence temperature on the territory of Croatia, for example altitude, latitude, proximity to sea or anything else, which could be used for another study (krigging with multiple variables)?
...
temp.ST = krigeST(values ~ 1, st_object, pred.grd, SimplesumMetric_Vgm)
```
